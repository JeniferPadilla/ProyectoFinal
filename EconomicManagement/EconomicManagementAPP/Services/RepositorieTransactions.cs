...
public class RepositorieTransactions: IRepositorieTransactions
{
    ...
    public async Task<IEnumerable<Transactions>> GetTransactions(int AccountId, int UserId)
    {
        ...
        return await connection.QueryAsync<Transactions>(@"SELECT TOP (20) t.Id, t.UserId, t.TransactionDate,
           t.Total, [ot].Description as OperationTypeDescription, t.Description, a.Name as AccountName,
